...
namespace CrozzleApplication
{
    class Coordinate
    {
        ...
        {
            // copy OriginalCoordinate
            String[] copyOriginalCoordinate = new String[coordinate.OriginalCoordinate.Length];
            Array.Copy(coordinate.OriginalCoordinate, copyOriginalCoordinate, coordinate.OriginalCoordinate.Length);
            OriginalCoordinate = copyOriginalCoordinate;
